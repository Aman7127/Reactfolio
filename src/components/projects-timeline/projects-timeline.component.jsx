              ...
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>The Head of Department would use this software to manage the data of a Prison all by his own.👮<br/>
Fork, clone, play with the code and feel free to PR for any issues or new versions!</strong> 
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
